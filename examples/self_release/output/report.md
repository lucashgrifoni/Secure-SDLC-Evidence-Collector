...
|---------|-----------|--------|-------------|------------|---------------|
| `SSDF-PW.7` | NIST_SSDF | **met** | high | high | sast-55fbbe9168c1 |
| `SSDF-PW.4` | NIST_SSDF | **met** | high | high | sca-3a20656ad937 |
| `ORG-SECRETS-SCAN` | ORG_INTERNAL | **met** | high | high | secrets-ad34de793c52 |
| `SSDF-PS.3` | NIST_SSDF | **met** | critical | low | sbom-355e550ac997, att-cc948cb8a6a4, att-35354bda8818 |
| `SSDF-PW.8` | NIST_SSDF | **met** | high | high | test-44328ed657f7 |
...
| `SAMM-IMPL-SB-2` | OWASP_SAMM | **met** | high | low | sbom-355e550ac997, att-35354bda8818, att-cc948cb8a6a4 |
| `SAMM-VERIF-ST-1` | OWASP_SAMM | **met** | high | low | sast-55fbbe9168c1, sca-3a20656ad937, att-db21182f1d7e |

### Rationales

- **`SSDF-PW.7` — Review and/or analyze human-readable code (SAST)**
  Control SSDF-PW.7 is met by evidence ['sast-55fbbe9168c1'].
- **`SSDF-PW.4` — Reuse existing, well-secured software (SCA)**
  Control SSDF-PW.4 is met by evidence ['sca-3a20656ad937'].
- **`ORG-SECRETS-SCAN` — Repository-wide secrets scanning**
  Control ORG-SECRETS-SCAN is met by evidence ['secrets-ad34de793c52'].
- **`SSDF-PS.3` — Archive and protect each software release (SBOM)**
  Control SSDF-PS.3 is met by evidence ['sbom-355e550ac997', 'att-cc948cb8a6a4', 'att-35354bda8818'].
- **`SSDF-PW.8` — Test executable code to identify vulnerabilities**
  Control SSDF-PW.8 is met by evidence ['test-44328ed657f7'].
...
- **`SAMM-IMPL-SB-2` — Secure Build (Implementation / Secure Build 2)**
  Control SAMM-IMPL-SB-2 is met by evidence ['sbom-355e550ac997', 'att-35354bda8818', 'att-cc948cb8a6a4'].
- **`SAMM-VERIF-ST-1` — Security Testing (Verification / Security Testing 1)**
  Control SAMM-VERIF-ST-1 is met by evidence ['sast-55fbbe9168c1', 'sca-3a20656ad937', 'att-db21182f1d7e'].
...
|----|------|--------|------------|----------|---------|
| `sast-55fbbe9168c1` | sast_scan | passed | high | Bandit | `17dede200000000000000000000000000000000a` |
| `secrets-ad34de793c52` | secrets_scan | passed | high | gitleaks | `17dede200000000000000000000000000000000a` |
| `test-44328ed657f7` | test_result | passed | high | pytest tests | `17dede200000000000000000000000000000000a` |
| `sca-3a20656ad937` | sca_scan | passed | high | pip-audit | `17dede200000000000000000000000000000000a` |
| `sbom-355e550ac997` | sbom | generated | high | cyclonedx | `secure-sdlc-evidence-collector@0.1.0` |
...
- **Findings:** critical=0 · high=0 · medium=0 · low=0 · info=0- **Artifact:** `examples\self_release\artifacts\bandit.sarif` (sha256:9cf1c50d5feab00a4c298be9ad0e811e2cd14370789f4c74829f17ae239002b0)

### `secrets-ad34de793c52` — secrets_scan
...
- **Findings:** critical=0 · high=0 · medium=0 · low=0 · info=0- **Artifact:** `examples\self_release\artifacts\gitleaks.sarif` (sha256:a07edbd00c4ca0042372afcc8ca20fc0e170e8f7259c49cfab11e5b47b2bde99)

### `test-44328ed657f7` — test_result
...
- **Findings:** total=45 · failures=0 · errors=0 · skipped=0- **Artifact:** `examples\self_release\artifacts\junit.xml` (sha256:17f291d68064d169d7c7c9d871fce17fd45daa762277061a537cf050afaf9647)

### `sca-3a20656ad937` — sca_scan
...
- **Findings:** critical=0 · high=0 · medium=1 · low=0 · info=0- **Artifact:** `examples\self_release\artifacts\pip-audit.sarif` (sha256:5d46f2a1e5d830f6cd3cae862aa08b3d8093b230bf7cc1bc3110e5321a423faa)

### `sbom-355e550ac997` — sbom
...
- **Findings:** components=260- **Artifact:** `examples\self_release\artifacts\sbom.cdx.json` (sha256:5e40f579715c4e61f034d712a723c621810e736040888e6d92193179a77b23d6)
