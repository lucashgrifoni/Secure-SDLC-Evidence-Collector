...
**Bundle ID:** `bundle-20260504-secure-sdlc-evidence-collector-v1.0.1-8d6406da`
**Bundle version:** 1.0.0
**Generated at:** 2026-05-04T22:10:20.480365+00:00
...
|-------|-------|
| Release ID | `v1.0.1` |
| Commit SHA | `4a59c74da2f4ea9d373babefd20179e98cb5538a` |
| Branch | `main` |
| Pipeline run | - |
| Build ID | - |
| Artifact digest | `-` |
...
|---------|-----------|--------|-------------|------------|---------------|
| `SSDF-PW.7` | NIST_SSDF | **met** | high | high | sast-a73aad25fce0 |
| `SSDF-PW.4` | NIST_SSDF | **met** | high | high | sca-48075d21e124 |
| `ORG-SECRETS-SCAN` | ORG_INTERNAL | **met** | high | high | secrets-b9daaa361620 |
| `SSDF-PS.3` | NIST_SSDF | **met** | critical | low | sbom-fa4411ec7c46, att-cc948cb8a6a4, att-35354bda8818 |
| `SSDF-PW.8` | NIST_SSDF | **met** | high | high | test-48af5b17005e |
...
| `SAMM-VERIF-ST-1` | OWASP_SAMM | **met** | high | low | sast-a73aad25fce0, sca-48075d21e124, att-db21182f1d7e |

### Rationales

- **`SSDF-PW.7` — Review and/or analyze human-readable code (SAST)**
  Control SSDF-PW.7 is met by evidence ['sast-a73aad25fce0'].
- **`SSDF-PW.4` — Reuse existing, well-secured software (SCA)**
  Control SSDF-PW.4 is met by evidence ['sca-48075d21e124'].
- **`ORG-SECRETS-SCAN` — Repository-wide secrets scanning**
  Control ORG-SECRETS-SCAN is met by evidence ['secrets-b9daaa361620'].
...
- **`SSDF-PW.8` — Test executable code to identify vulnerabilities**
  Control SSDF-PW.8 is met by evidence ['test-48af5b17005e'].
...
- **`SAMM-VERIF-ST-1` — Security Testing (Verification / Security Testing 1)**
  Control SAMM-VERIF-ST-1 is met by evidence ['sast-a73aad25fce0', 'sca-48075d21e124', 'att-db21182f1d7e'].
...
|----|------|--------|------------|----------|---------|
| `sast-a73aad25fce0` | sast_scan | passed | high | Bandit | `4a59c74da2f4ea9d373babefd20179e98cb5538a` |
| `secrets-b9daaa361620` | secrets_scan | passed | high | gitleaks | `4a59c74da2f4ea9d373babefd20179e98cb5538a` |
| `test-48af5b17005e` | test_result | passed | high | pytest tests | `4a59c74da2f4ea9d373babefd20179e98cb5538a` |
| `sca-48075d21e124` | sca_scan | passed | high | pip-audit | `4a59c74da2f4ea9d373babefd20179e98cb5538a` |
...
### `sast-a73aad25fce0` — sast_scan

- **Source:** Bandit (sarif) · version 1.9.4- **Producer:** Bandit
- **Subject:** `4a59c74da2f4ea9d373babefd20179e98cb5538a` (commit)
...
### `secrets-b9daaa361620` — secrets_scan
